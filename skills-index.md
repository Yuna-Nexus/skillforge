...
> 收集全网优质 AI Skill 平台、GitHub 仓库及推荐技能

---

## 第一部分：AI Skill 平台与资源汇总
...
| OpenCode Skills Backup | https://github.com/wsxwj123/opencode-skills-backup | OpenCode 技能备份仓库 |
...
| 来源名称 | 来源链接 | Skill 名称 | Skill 描述 | Skill 链接 | 推荐等级 | 推荐原因 |
|---------|---------|-----------|-----------|-----------|---------|---------|
...
| OpenCode Skills Backup | https://github.com/wsxwj123/opencode-skills-backup | review-writing | 高影响力学术文献综述 | 仓库内 | ⭐⭐ | Nature/Cell/Lancet 级别综述写作 |
...
| 来源名称 | 来源链接 | Skill 名称 | Skill 描述 | Skill 链接 | 推荐等级 | 推荐原因 |
|---------|---------|-----------|-----------|-----------|---------|---------|
| 我的原创 | https://github.com/Yuna-Nexus | article-writing | SCI 论文写作辅助 | 仓库内 | ⭐ | 个人开发的论文写作技能 |
| 我的原创 | https://github.com/Yuna-Nexus | research-publication-strategy | 科研发表策略分析 | 仓库内 | ⭐ | 科研方向与期刊选择辅助 |
| Skills.sh | https://skills.sh/ | (目录) | Agent 技能目录 | https://skills.sh/ | ⭐ | 一键安装各类 Agent 技能 |
